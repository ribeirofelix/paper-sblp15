...
and is therefore suitable for languages that may be embedded using
...
%% TODO : melhorar a intro desta seção, deixando CLARO que aqui comeca nossa contribuição

%% TODO: Quais features necessarias numa linguagem para implementar nossa solução?(aqui ou na conclusão)
