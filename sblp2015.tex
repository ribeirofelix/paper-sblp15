...
The \texttt{toAST(func)} function calls the function \textttt{luadec(arg)} that belongs to \texttt{libluadec}, sending the function that will be transformed in AST as argument.
