...
% antes de falar dos parâmetros: o que a função faz?
...
% formatar os nomes bonitinho com \texttt{} como no resto do paper
...
% ? "this function joins... but to use this function we need another one to join"? tá bem confuso
